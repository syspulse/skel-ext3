...
object Dependencies {
    ...
    val libSkelJob =        "io.syspulse"                 %% "skel-job"             % skelVersion
    val libSkelIngestCore = "io.syspulse"                 %% "ingest-core"          % skelVersion
    val libSkelIngestTwitter ="io.syspulse"               %% "ingest-twitter"       % skelVersion
    ...
    val libSkelBlockchainLabel = "io.syspulse"            %% "blockchain-label"     % skelVersion  
    val libSkelBlockchainEvm = "io.syspulse"              %% "blockchain-evm"       % skelVersion
    val libSkelBlockchainRpc = "io.syspulse"              %% "blockchain-rpc"       % skelVersion  
    val libSkelPlugin =     "io.syspulse"                 %% "skel-plugin"          % skelVersion    
    val libSkelAiCore =     "io.syspulse"                 %% "ai-core"              % skelVersion
    val libSkelAi =         "io.syspulse"                 %% "skel-ai"              % skelVersion
    val libSkelDns =        "io.syspulse"                 %% "skel-dns"             % skelVersion  
    val libSkelTls =        "io.syspulse"                 %% "skel-tls"             % skelVersion  
    ...
    val libExtSentinel =   "io.syspulse"                 %% "ext-sentinel"          % extVersion

    // =========================================================================================
    val libTrunkCore =       "io.syspulse"                 %% "trunk-core"          % trunkVersion
    val libTrunkEth =        "io.syspulse"                 %% "trunk-eth"           % trunkVersion
